...
public class MovingAndCollisions extends JPanel implements Runnable, KeyListener {
	...
	Rectangle[] walls = new Rectangle[7];
	Rectangle [] coins = new Rectangle [4];
	...
	public void initialize() {
		...
		walls[5] = new Rectangle(400, 150, 70, 80);
		walls [6] = new Rectangle (100, 200, 70, 75);
		
		coins [0] = new Rectangle(200, 50, 20, 20);
		coins [1] = new Rectangle(550, 40, 20, 20);
		coins [2] = new Rectangle(300, 300, 20, 20);
		coins [3] = new Rectangle(30, 550, 20, 20);
	}
	...
	public void update() {
		...
		for (int i = 0; i < coins.length; i++) {
			if (rect.intersects(coins[i])) {
				coins[i] = new Rectangle (0, 0, 0, 0);
				coinsNum++;
			}
		}
	}
	...
	public void paintComponent(Graphics g) {
		...
		g.setFont(myFont);
		g.drawString("coins collected:" + coinsNum, 10, 50);
	}
